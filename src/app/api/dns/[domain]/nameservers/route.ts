...
import { dnsUpdateNameservers } from "@/services/dns.service";

export const dynamic = "force-dynamic";

const LIMIT = { prefix: "dns-nameservers", limit: 20, windowSec: 60 };
...
export async function PUT(request: NextRequest, context: Context) {
  ...
  const result = await dnsUpdateNameservers(ctx, domain, body);
