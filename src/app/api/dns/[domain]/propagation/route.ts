...
import { dnsCheckPropagation } from "@/services/dns.service";

export const dynamic = "force-dynamic";

const LIMIT = { prefix: "dns-propagation", limit: 15, windowSec: 60 };
...
export async function POST(request: NextRequest, context: Context) {
  ...
  const result = await dnsCheckPropagation(ctx, domain);
