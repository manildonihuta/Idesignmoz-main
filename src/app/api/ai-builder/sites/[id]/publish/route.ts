...
import { publishSite } from "@/services/ai-builder.service";
import type { ServiceFailure, ServiceSuccess } from "@/services/result";

export const dynamic = "force-dynamic";

const LIMIT = { prefix: "ai-builder-publish", limit: 10, windowSec: 600 };
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  const result: ServiceSuccess<unknown> | ServiceFailure = await publishSite(ctx as AuthContext, id);
